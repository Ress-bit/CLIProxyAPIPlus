...
func GetCodeBuddyModels() []*ModelInfo {
	...
	return []*ModelInfo{
		{
			ID:                        "codebuddy/default-model-lite",
			Object:                    "model",
			Created:                   now,
			OwnedBy:                   "tencent",
			Type:                      "codebuddy",
			DisplayName:               "Default Lite",
			Description:               "Default Lite via CodeBuddy",
		...
		},
		{
			...
			Description:               "Gemini 3.1 Pro via CodeBuddy",
		...
		{
			ID:                  "codebuddy/deepseek-v3-2-volc",
			Object:              "model",
			Created:             now,
			OwnedBy:             "tencent",
			Type:                "codebuddy",
		...
		{
			ID:                        "codebuddy/gemini-3.0-pro-image",
			Object:                    "model",
			Created:                   now,
			OwnedBy:                   "tencent",
			Type:                      "codebuddy",
			DisplayName:               "Gemini 3.0 Pro Image",
			Description:               "Gemini 3.0 Pro Image via CodeBuddy",
			SupportedEndpoints:        []string{"/images/generations", "/images/edits"},
			SupportedInputModalities:  []string{"TEXT", "IMAGE"},
			SupportedOutputModalities: []string{"IMAGE"},
		},
		{
			ID:                        "codebuddy/gemini-3.1-flash-image",
			Object:                    "model",
			Created:                   now,
			OwnedBy:                   "tencent",
			Type:                      "codebuddy",
			DisplayName:               "Gemini 3.1 Flash Image",
			Description:               "Gemini 3.1 Flash Image via CodeBuddy",
			SupportedEndpoints:        []string{"/images/generations", "/images/edits"},
			SupportedInputModalities:  []string{"TEXT", "IMAGE"},
			SupportedOutputModalities: []string{"IMAGE"},
		},
		{
			ID:                        "codebuddy/gemini-2.5-flash-image",
			Object:                    "model",
			Created:                   now,
			OwnedBy:                   "tencent",
			Type:                      "codebuddy",
			DisplayName:               "Gemini 2.5 Flash Image",
			Description:               "Gemini 2.5 Flash Image via CodeBuddy",
			SupportedEndpoints:        []string{"/images/generations", "/images/edits"},
			SupportedInputModalities:  []string{"TEXT", "IMAGE"},
			SupportedOutputModalities: []string{"IMAGE"},
		},
		{
			ID:                        "codebuddy/hunyuan-image-v3.0",
			Object:                    "model",
			Created:                   now,
			OwnedBy:                   "tencent",
			Type:                      "codebuddy",
			DisplayName:               "Hunyuan Image V3",
			Description:               "Hunyuan Image V3 via CodeBuddy",
			SupportedEndpoints:        []string{"/images/generations"},
			SupportedInputModalities:  []string{"TEXT"},
			SupportedOutputModalities: []string{"IMAGE"},
		},
		{
			ID:                        "codebuddy/hunyuan-image-v2.0-general-edit",
			Object:                    "model",
			Created:                   now,
			OwnedBy:                   "tencent",
			Type:                      "codebuddy",
			DisplayName:               "Hunyuan Image Edit",
			Description:               "Hunyuan Image Edit via CodeBuddy",
			SupportedEndpoints:        []string{"/images/edits"},
